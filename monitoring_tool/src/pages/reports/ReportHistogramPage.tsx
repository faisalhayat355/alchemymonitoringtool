...
import ReportHistogramTabPage from './reportHistogramTab/ReportHistogramTabHomePage';


const ReportHistogramPage = () => {
...
export default ReportHistogramPage
